...
class Base64Converter {
    ...
    companion object {
        fun drawableToString(drawable: Drawable) : String {
            ...
            val fotoPost = Base64.encodeToString(outputStream.toByteArray(),0)
            return fotoPost
        }
        fun stringToBitmap(fotoPost: String) : Bitmap {
            val imageBytes = Base64.decode(fotoPost, Base64.DEFAULT)
